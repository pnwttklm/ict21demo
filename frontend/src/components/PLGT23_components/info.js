...
export default function() {
    return (
        <>
            <div className='rounded-3xl bg-[#1D1D1F] w-1/2 p-12'>
                <div className='flex flex-col gap-10'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <div className='flex justify-end'>
                            <h1 className=' text-transparent bg-clip-text font-extrabold text-3xl bg-gradient-to-l from-[#FF6B00] to-[#8F00FF]'>DAY 2</h1>
                        </div>
                        <p className='text-[#F5F5F7] text-right'>Mark your calendars and be part of this extraordinary opportunity to kickstart your college journey with the Faculty of ICT.
                            As you step into the latest batch of our esteemed faculty, get ready to delve into the world of cutting-edge technologies and enriching education.
                            This is your chance to connect with ICT Ajarns, experienced senpais, and fellow developers.
                        </p>
                    </div>
            ...
            <div className=' mt-6 items-center'></div>
